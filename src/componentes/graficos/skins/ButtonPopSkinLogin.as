...
package componentes.graficos.skins
{
	...
	import componentes.graficos.skins.fxg.Button_down_popLogin;
	import componentes.graficos.skins.fxg.Button_up_pop;
	import componentes.graficos.skins.fxg.Button_up_pop2;
	import componentes.graficos.skins.fxg.Button_up_popLogin;
	 ...
	 */
	public class ButtonPopSkinLogin extends ButtonSkinBase
	{
		//--------------------------------------------------------------------------
		//
		//  Class constants
		 ...
		 *  @productversion Flex 4.5
		 */
		public function ButtonPopSkinLogin()
		{
			super();
			...
			upBorderSkin = Button_up_popLogin;
			downBorderSkin = Button_down_popLogin;
			//downBorderSkin = null;
			layoutCornerEllipseSize = 0;
			layoutBorderSize = 0;
		}
