...
package componentes.graficos.skins
{
	
	import componentes.graficos.skins.fxg.BtnPop_up;
	import componentes.graficos.skins.fxg.Button_down_pop;
	import componentes.graficos.skins.fxg.Button_up_pop;
	import componentes.graficos.skins.fxg.Button_up_pop2;
	import componentes.graficos.skins.fxg.Button_up_pop_Fin;
	import componentes.graficos.skins.fxg.Button_up_pop_FinLogin;
	 ...
	 */
	public class ButtonPopFinLoginSkin extends ButtonSkinBase
	{
		//--------------------------------------------------------------------------
		//
		//  Class constants
		 ...
		 *  @productversion Flex 4.5
		 */
		public function ButtonPopFinLoginSkin()
		{
			super();
			...
			upBorderSkin = Button_up_pop_FinLogin;
			downBorderSkin = Button_down_pop;
			//downBorderSkin = null;
			layoutCornerEllipseSize = 0;
			layoutBorderSize = 0;
		}
		...
		{   
			...
			if(this.currentState == 'down'){
				...
				labelDisplay.textColor = hostComponent.getStyle('color');
			}
